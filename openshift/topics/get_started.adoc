...
[source,bash,subs="attributes+,macros+"]
----
$ oc login -u kubeadmin -p removing-kubeadmin[kubeadmin_password] \https://openshift.example.com:6443
----
See link:https://docs.openshift.com/container-platform/latest/authentication/remove-kubeadmin.html#understanding-kubeadmin[removing the kubeadmin user] for more details.
